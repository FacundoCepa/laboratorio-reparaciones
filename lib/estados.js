...
// Lista de pasos a mostrar en el riel de progreso: si el equipo quedó
// "no reparado", ese paso reemplaza visualmente a "reparado".
export const pasosParaRiel = (estadoActual) =>
  estadoActual === "no_reparado" ? ESTADOS.map((e) => (e.key === "reparado" ? ESTADO_NO_REPARADO : e)) : ESTADOS;
